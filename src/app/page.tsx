  ...
  return (
    <div style={{ minHeight: '100vh' }}>
      ...
      <div style={{ backgroundColor: '#CDB4DB' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '8px 16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'white' }}>
          <div style={{ 
            fontWeight: 'bold', 
            fontSize: '1.25rem',
      ...
      {/* Hero Section */}
      <div style={{ backgroundColor: '#CDB4DB', position: 'relative', overflow: 'hidden', paddingBottom: '100px' }}>
            ...
            {[
              {
                ...
                description: 'Practice with live market conditions using real-time stock data and market indicators.',
                bgColor: '#BDE0FE'
              },
              {
                icon: '📈',
                title: 'Portfolio Tracking',
                description: 'Monitor your virtual portfolio performance and track your trading history.',
                bgColor: '#FFAFCC'
              },
              {
                icon: '🤖',
                title: 'AI Trading Models',
                description: 'Create and backtest ML trading models. Compare performance across different strategies and market conditions.',
                bgColor: '#A2D2FF'
              }
            ].map((feature, index) => (
              <div key={index} style={{ 
      ...
      {/* CTA Section */}
      <div style={{ backgroundColor: '#CDB4DB', padding: '64px 0', textAlign: 'center' }}>
